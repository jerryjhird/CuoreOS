...
#define PTE_STATE_RESERVED0 3 // 3 (011)
#define PTE_STATE_RESERVED1 4 // 4 (100)
#define PTE_STATE_RESERVED2 5 // 5 (101)
#define PTE_STATE_RESERVED3 6 // 6 (110)
#define PTE_STATE_RESERVED4 7 // 7 (111)
...
#define PTE_TYPE_RESERVED0 (3ULL << 9)	 // Bit 11=0 | Bit 10=1 | Bit 9=1
#define PTE_TYPE_RESERVED1 (4ULL << 9) // Bit 11=1 | Bit 10=0 | Bit 9=0
#define PTE_TYPE_RESERVED2 (5ULL << 9) // Bit 11=1 | Bit 10=0 | Bit 9=1
#define PTE_TYPE_RESERVED3 (6ULL << 9) // Bit 11=1 | Bit 10=1 | Bit 9=0
#define PTE_TYPE_RESERVED4 (7ULL << 9) // Bit 11=1 | Bit 10=1 | Bit 9=1
